  ...
  return (
    <section className="w-[1550px] mx-auto">
      ...
      <article className="flex justify-center">
        <Link
          to="/NewsPage"
          className="w-[130px] h-[40px] rounded-full mt-[150px] py-2 px-4 text-base font-medium text-[#04B7A1] border border-solid border-customGreen hover:bg-[#04B7A1] transition-colors duration-300 ease-in-out cursor-pointer hover:text-[#F8F7F7] ml-5 text-center"
        >
          View More
        </Link>
      </article>
